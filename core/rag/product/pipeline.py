...
from core.rag.product.chunk import build_all_chunks
from core.rag.product.config import CATALOG_PATH, CHAT_MODEL, RAG_PROMPT, RETRIEVAL_K
from core.rag.product.generate import format_context, generate_answer_with_metadata
from core.rag.product.hybrid import hybrid_retrieve, reset_bm25_cache
from core.rag.product.load import load_products
from core.rag.product.rerank import rerank_chunks
from core.rag.product.rewrite import rewrite_query
from core.rag.product.store import build_vector_store, chroma_exists, load_vector_store
from core.rag.scoring import sources_from_retrieved as _sources_from_retrieved
from core.rag.product.catalog_agent import (
...
def warm_product_rag() -> None:
    ...
    from core.rag.product.hybrid import build_bm25_index
    from core.rag.product.rerank import load_reranker
