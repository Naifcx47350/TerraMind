"""General RAG — public API used by core.models.general_rag."""
...
from core.rag.general.chunk import chunk_documents
from core.rag.general.config import RETRIEVAL_K
from core.rag.general.generate import generate_answer
from core.rag.general.load import load_documents
from core.rag.general.retrieve import format_context, retrieve_chunks
from core.rag.general.store import _chroma_exists, build_chroma_db
