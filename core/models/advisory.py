...
from core.rag.general import get_general_db, sources_from_retrieved as general_sources
from core.rag.general.config import CHAT_MODEL, RETRIEVAL_K as GENERAL_K
from core.rag.general.retrieve import format_context as format_general_context
from core.rag.general.retrieve import retrieve_chunks
from core.rag.llm_stream import stream_chat_tokens
from core.rag.product import (
    format_context as format_product_context,
    get_product_db,
    retrieve_products,
    sources_from_retrieved as product_sources,
)
from core.rag.product.config import RETRIEVAL_K as PRODUCT_K
from core.rag.scoring import aggregate_retrieval_score, confidence_from_score
...
def answer_advisory(
    ...
    g_score = aggregate_retrieval_score(general_retrieved)
    p_score = aggregate_retrieval_score(product_retrieved)
    from core.rag.scoring import confidence_from_retrieval
