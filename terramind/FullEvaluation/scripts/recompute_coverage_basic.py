...
Run:
    python -m terramind.FullEvaluation.scripts.recompute_coverage_basic
"""
import sys
import json
...
from terramind.FullEvaluation.metrics.metrics import coverage_judge_score
from terramind.FullEvaluation.evaluate import REPORTS_DIR
