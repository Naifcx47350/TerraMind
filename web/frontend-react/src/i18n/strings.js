export const STRINGS = {
  en: {
    ...
    voiceInputHint: "Speak instead of typing",
    voiceHoldToRecord: "Hold to record",
    voiceClickToToggle: "Click to start / stop",
    voiceListening: "Listening…",
    voiceUnsupported: "Speech recognition is not supported in this browser",
    voiceNoDevices: "No microphone devices found",
    voiceDevices: "Microphone",
  ...
  ar: {
    ...
    textSize: "حجم النص",
    textSizeTiny: "صغير جداً",
    textSizeSmall: "صغير",
    textSizeDefault: "عادي",
    textSizeLarge: "كبير",
    textSizeExtraLarge: "كبير جداً",
    textSizeVeryLarge: "كبير جداً جداً",
    textSizeMaximum: "الأكبر",
    ...
    voiceInputHint: "تحدث بدل الكتابة",
    voiceHoldToRecord: "اضغط مطولًا للتسجيل",
    voiceClickToToggle: "اضغط للبدء / الإيقاف",
    voiceListening: "يستمع…",
    voiceUnsupported: "التعرف على الكلام غير مدعوم في هذا المتصفح",
    voiceNoDevices: "لم يتم العثور على ميكروفون",
    voiceDevices: "الميكروفون",
